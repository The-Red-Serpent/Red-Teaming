...
## COM
COM is a Windows system that allows programs written in  different programming languages and by different developers to communicate with each other. It does this by exposing standardized interfaces that define what methods are available and how they can be used, without revealing how the component is implemented internally.
